...
def show_all_posts():
    ...
    for post in all_posts:
        ...
        posted= {"postid":post.id,"userid": post.user_id, "username": user.username, "profilephoto": user.image, "photo": post.postimage, "caption": post.caption, "created_on": postdate, "likes": likes, "likeflag": likeflag}
