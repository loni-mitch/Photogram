...
def get_user(user_id):
    ...
    if (int(user_id) == session['userid']):
        ...
        user_info = {"userid": user.id, "username": user.username, "firstname": user.firstname, "lastname": user.lastname, "email": user.email, "location": user.location, "biography": user.biography,"photo": user.image, "joined_on": datejoin}
