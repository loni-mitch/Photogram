...
def show_all_posts():
    ...
    for post in all_posts:
        ...
        posted= {"postid":post.id,"userid": post.user_id, "username": user.username, "pro_photo": user., "photo": post.photo, "caption": post.caption, "created_on": postdate, "likes": numberoflikes, "likeflag": likeflag}
